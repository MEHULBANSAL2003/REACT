...
const Instamart = () => {
  let [visibleConfig,setVisibleConfig]=useState({
    showAbout:false,
    showTeam:false,
    showContact:false
  });
  ...
  return (
    ...
    <div>
      ...
      <Section
        ...
        isVisible={visibleConfig.showAbout}
        setIsVisible={()=>setVisibleConfig({
          showAbout:true,
          showTeam:false,
          showContact:false
        })}
      ...
      <Section
        ...
        isVisible={visibleConfig.showTeam}
        setIsVisible={()=>setVisibleConfig({
          showAbout:false,
          showTeam:true,
          showContact:false
      ...
      <Section
        ...
        isVisible={visibleConfig.showContact}
        setIsVisible={()=>setVisibleConfig({
          showAbout:false,
          showTeam:false,
          showContact:true
